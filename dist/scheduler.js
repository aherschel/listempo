...
export class Scheduler {
     ...
     */
    static shouldGenerateTask(template, today) {
     ...
     */
    static generateTaskFromTemplate(template, today) {
        const task = {
            id: this.generateId(),
     ...
     */
    static getScheduleDescription(template) {
        switch (template.frequency) {
            case 'daily':
                return 'Every day';
            case 'weekly':
